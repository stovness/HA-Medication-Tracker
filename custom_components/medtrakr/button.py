...
async def async_setup_entry(
    ...
    entities = [
        MedicationTakeButton(store, config_entry, med_id, name),
        MedicationUndoButton(store, config_entry, med_id, name),
    ]
...
class MedicationTakeButton(ButtonEntity):
    ...
    def __init__(self, store, config_entry, med_id: str, med_name: str) -> None:
        self._store = store
        self._config_entry = config_entry
        self._med_id = med_id
        self._attr_unique_id = f"{med_id}_take"
        self._attr_name = f"{med_name} Take"
...
class MedicationUndoButton(ButtonEntity):
    ...
    def __init__(self, store, config_entry, med_id: str, med_name: str) -> None:
        ...
        self._attr_name = f"{med_name} Undo"
